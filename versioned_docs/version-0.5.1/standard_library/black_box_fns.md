...
You can view the black box functions defined in the ACVM code [here](https://github.com/noir-lang/acvm/blob/acir-v0.10.3/acir/src/circuit/black_box_functions.rs).
